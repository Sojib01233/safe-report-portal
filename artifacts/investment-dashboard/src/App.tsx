      ...
      <div className="flex min-h-[100dvh]">
        ...
        <div className="min-w-0 flex-1">
          ...
          <main className="content-wrap">
            ...
            {view === 'mining' && <MiningPage day={miningDay} progress={miningProgress} returnValue={miningReturn} onCheckIn={checkInMining} />}
            {view === 'profile' && <ProfilePage score={score} dollars={swappedDollars} swapInput={swapInput} setSwapInput={setSwapInput} onSwap={swapPoints} onWithdraw={() => setWithdrawOpen(true)} />}
          </main>
        </div>
      </div>
